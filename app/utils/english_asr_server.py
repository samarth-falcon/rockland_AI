...
async def start():
    ...
    args.port = int(os.environ.get('VOSK_SERVER_PORT', 2710))
    args.model_path = os.environ.get('VOSK_MODEL_PATH', '/home/samarth/testing/extra_testing/local_salesphony_testing/salesphony_testing/vox/asr_model/english_general')
