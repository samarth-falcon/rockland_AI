...
async def handle_websocket(websocket):
    ...
    while True:
        ...
        # print(response)
        transcript += response["PartialTranscript"][0]
        print(transcript)
...
async def start():
    ...
    # loading all models
    # asr_processor = Wav2Vec2Processor.from_pretrained("/opt/SpeechEmotionRecognition/asr/data/model_V1")
    asr_processor = Wav2Vec2Processor.from_pretrained("/opt/janelaaj/ml_models/SpeechEmotionRecognition/asr/data/model_V1")
    # asr_model = Wav2Vec2ForCTC.from_pretrained("/opt/SpeechEmotionRecognition/exp/asr/checkpoint-10400")
    asr_model = Wav2Vec2ForCTC.from_pretrained("/opt/janelaaj/ml_models/SpeechEmotionRecognition/exp/asr/checkpoint-10400")
