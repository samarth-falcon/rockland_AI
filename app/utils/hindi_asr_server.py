...
async def start():
    ...
    args.model_path = os.environ.get('VOSK_MODEL_PATH', '/home/samarth/testing/extra_testing/local_salesphony_testing/salesphony_testing/vox/asr_model/hindi_general')
